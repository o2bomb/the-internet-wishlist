import { FormControl, FormErrorMessage, FormHelperText, FormLabel, Input, Textarea } from "@chakra-ui/core";
  ...
  return (
    <FormControl isRequired={required} isInvalid={!!error}>
      ...
      <InputOrTextArea
        type={type}
        id={field.name}
        aria-describedby={helperText ? `${field.name}-helper-text` : undefined}
        {...props}
        {...field}
      />
      {helperText ? (
